...
This repository provides the STM32Cube **WM-Bus** Middleware Library, **common to every** STM32Cube MCU firmware that supports it.

## Release note

Details about the content of this release are available in the release note [here](https://htmlpreview.github.io/?https://github.com/STMicroelectronics/stm32-mw-wmbus/blob/main/Release_Notes.html).
